...
const TILEMAPS: Record<string, TilemapData> = {
  ...
  f100_r01: {
    ...
    props: [
      ...
      { kind: "cave_tree_large", x: 10, y: 8 },
      // Beast-hero statues of the Labyrinth (one tile north so a torch
      // fits in front of each, facing Cedric).
      ...
      // Cedric's sleeping rock — large boulder against the north wall.
      // The pillow rests beside it, suggesting he sleeps curled on the
      // stone like a lion.
      { kind: "cave_rock", x: 6, y: 1 },
      { kind: "cave_pillow", x: 7, y: 1 },
    ],
  },
